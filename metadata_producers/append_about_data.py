...
def classify_about(single_json, generated_list):
    prompt = f'''
    ...
    step 8: For the text, select a key-value pair of Attributes and connections from the dictionary provided: {generated_list[1]["Attributes and connections"]} .
    step 9: Classify the text into one of the Formal representations from the list of Formal representations provided: {generated_list[1]["formal_representations"]}.
