...
'''
# listgen = generateList(summary, about_list_generation_prompt, depth_list_generation_prompt, "English", text_message, gpt4o_encoder, gpt4o)
# print(listgen)
...
# fat_json = generateList(summary, about_list_generation_prompt,depth_list_generation_prompt, "English", text_message, gpt4o_encoder, gpt4o)
...
res = topic_agent(jsonnnnn, "English", gpt4o_encoder, gpt4o, topic_prompt, count=0)
# print(res)

res2 = concept_agent(jsonnnnn, "English", gpt4o_encoder, gpt4o, concept_prompt, count=0)
# print(res2)

res3 = subtopic_agent(jsonnnnn, "English", gpt4o_encoder, gpt4o, subtopic_prompt, count=0)
# print(res3)
...
final_json = {**res, **res2, **res3, **res4, **res5, **res6, **res7, **res8, **res9, **res10, **res11, **res12}
print(final_json)


# ##############
# print("==============================")
# valid = json_validator(res, summary, "English", gpt4o_encoder, gpt4o, validator_prompt, flag=False)
# print(valid)
